...
let agregarMas = "si";  // valor inicial como "sí", porque la primera vez siempre va a entrar en el while
while(agregarMas != "no"){
    ...
    if(agregarMas === "si"){  //si el texto leído es "sí", preguntar por la comida y la categoría
